...
![Figure 2.1.6](./79_wil1_prog-resources/02_data-model.png)

Figure 2.1.6 shows the Entity Relational Diagram of our database storing identification.
...
![Figure 2.1.7](./79_wil1_prog-resources/02_network-specification.png)

Figure 2.1.7 shows the connection between 3 different layers, namely application, backend and data storage.
...
![Figure 2.1.8](./79_wil1_prog-resources/02_blockchain-database-architecture.png)

Figure 2.1.8 shows the design of the blockchain database we adopted.
