...
We would also allow an employer to provide feedback to the helper hired in our application, so future employers can have a more complete picture about that helper.
