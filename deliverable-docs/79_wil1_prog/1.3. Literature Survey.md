...
For example, Provenance is the platform that utilizes blockchain technology for recording the information produced along the supply chain [23].
With such platform, consumers can verify if the product they buy is genuine/ethical/sustainable.
A wine authentication system by blockchain company Guardtime, which is currently under development, also aims for a similar goal [24].
The BigchainDB (a blockchain database) team shared their collaboration with RWE (an energy provider in Germany).
The resulting system enables the communication of different small energy providers, the management of cash flows in a decentralized way under the energy deregulation in Germany [25].
Estonia, which is known for having digital society, claimed itself to be a blockchain nation [26].
...
Despite Estonia's effort to tackle this issue with e-Residency, a digital identity issued by the government, it is for EU-based companies only [27].
...
One criticism of Estonia's claim of having integrated blockchain into the governmental system [26] is that the details showing that the blockchain system implementation is indeed reliable, are lacking.
...
This can at least prevent a user from registering our system multiple times with, for example, multiple email addresses.
As a result, we have basic authenticity for our system.
...
One plausible solution for our system is to reach out to several existing platforms and convince them to join our blockchain network<!-- (?) -->.
...
Therefore, our system would also behave like an integrated platform that integrates several existing platforms.
...
[6] W.S.H. Ng, "Introduction," *Spring 2019 COMP 3311 Database Management Systems*, Dept. of Computer Science and Engineering, HKUST, 2019, p. 6.\
[7] M. El-Hindi et al., "BlockchainDB - A Shared Database on Blockchains," *Proceedings of the VLDB Endowment* (PVLDB 19), vol. 12, no. 11, 2019, pp. 1597–1609.\
[8] BigchainDB; <https://www.bigchaindb.com/>.\
[9] T. McConaghy, "BigchainDB Transactions Spec v2," GitHub, 26 Sept. 2018; <https://github.com/bigchaindb/BEPs/tree/master/13>.\
[10] "Querying BigchainDB," *BigchainDB Documentation*, BigchainDB; <https://docs.bigchaindb.com/en/latest/query.html>.\
[11] R. Mitra, "What is Tendermint Core? The Most Comprehensive Guide Ever," *Blockgeeks*, 2019; <https://blockgeeks.com/guides/tendermint/>.\
[12] Arrow Employment Services; <https://www.arrowes.hk/>.\
[13] Fair Employment Agency; <https://www.fairagency.org/>.\
[14] Lotus Employment Agency; <https://lotusmaid.com.hk:446/web/html/eng/index.jsp>.\
[15] Overseas Employment Centre; <https://www.overseas.com.hk/en/>.\
[16] "Employment of Domestic Helpers from Abroad," Hong Kong Immigration Department, 26 Nov. 2019; <https://www.immd.gov.hk/eng/forms/hk-visas/foreign-domestic-helpers.html>.\
[17] "Our Story," Fair Employment Agency; <https://www.fairagency.org/our-story/>.\
[18] HelperGo; <https://www.helpergo.co/>.\
[19] Smart Living; <https://www.erb.org/smartliving/en/main/>.\
[20] HelperChoice; <https://www.helperchoice.com/>.\
[21] HelperPlace; <https://www.helperplace.com/>.\
[22] "Standard Employment Contract and Terms of Employment for Helpers," Hong Kong Immigration Department, 26 Nov. 2019; <https://www.immd.gov.hk/eng/forms/forms/fdhcontractterms.html>.\
[23] Provenance; <https://www.provenance.org/>.\
[24] "Estonian-founded Guardtime to build wine authentication system in Australia," *e-Estonia*, Aug. 2019; <https://e-estonia.com/guardtime-wine-authentication-system/>.\
[25] T. McConaghy, "Trent McConaghy - BigchainDB: a Scalable Blockchain Database, in Python," YouTube, 31 May 2016; <https://www.youtube.com/watch?v=1NHHmHVCWy0>.\
[26] K. Korjus, "Welcome to the blockchain nation," Medium, 7 July 2017; <https://medium.com/e-residency-blog/welcome-to-the-blockchain-nation-5d9b46c06fd4>.\
[27] "What is e-Residency," *Knowledge Base*, e-Residency; <https://learn.e-resident.gov.ee/hc/en-us/articles/360000711978-What-is-e-Residency>
