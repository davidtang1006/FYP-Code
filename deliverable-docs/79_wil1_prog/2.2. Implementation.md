...
Our Blockchain database restricts users to operate the database through a blockchain under the supervision of the smart contract [7 (1.3)].
...
[1] J. Pregelj. "CRAB — Create. Retrieve. Append. Burn." The BigchainDB Blog. <https://blog.bigchaindb.com/crab-create-retrieve-append-burn-b9f6d111f460> (accessed Sep. 2019).\
[2] "NoSQL Databases Explained." MongoDB. <https://www.mongodb.com/nosql-explained> (accessed Sep. 2019).\
[3] "Blockchain." Microsoft Azure. <https://azure.microsoft.com/en-us/solutions/blockchain/> (accessed Sep. 2019).\
