...
![Figure 2.1.1: Use Case Diagram](./79_wil1_final-resources/02_functional-use-cases.png)
...
![Figure 2.1.2: User Interface for Domestic Helpers (Part 1)](./79_wil1_final-resources/02_user-interface-for-domestic-helpers-01.png)

Figure 2.1.2: User Interface for Domestic Helpers (Part 1)

![Figure 2.1.3: User Interface for Domestic Helpers (Part 2)](./79_wil1_final-resources/02_user-interface-for-domestic-helpers-02.png)

Figure 2.1.3: User Interface for Domestic Helpers (Part 2)

![Figure 2.1.4: User Interface for Employers (Part 1)](./79_wil1_final-resources/02_user-interface-for-employers-01.png)

Figure 2.1.4: User Interface for Employers (Part 1)

![Figure 2.1.5: User Interface for Employers (Part 2)](./79_wil1_final-resources/02_user-interface-for-employers-02.png)

Figure 2.1.5: User Interface for Employers (Part 2)

### 2.1.6. Network specifications

![Figure 2.1.6: Decentralized Network](./79_wil1_final-resources/02_decentralized-network.png)
